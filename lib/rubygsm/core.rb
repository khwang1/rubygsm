...
module Gsm
  class Modem
    ...
    def self.convert_string_from_ascii_to_char(ascii_string)
      ...
      return char_string
    end #convert_string_from_ascii_to_char()
    ...
    def receive(callback, interval=5, join_thread=false)
      ...
      @thr = Thread.new do
        ...
        while true
          ...
          # @incoming instance variable is defined in initialize()
